/* =====================================================================
 * US19 · pruebas de mutación
 *
 *   node tools/mutantes.js tools/mutantes_ficha.json
 *
...
(lista.acompana || []).forEach(function (rel) {
...
console.log('fuente: ' + (lista.fuente || 'index.html') + '  (se trabaja sobre una copia; el original no se toca)\n');
